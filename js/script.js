...
function showQuetions(index){
    ...
    let option_tag = '<div class="option"><span class="que">'+ questions[index].options[0] +'</span></div>'
    + '<div class="option"><span class="que">'+ questions[index].options[1] +'</span></div>'
    + '<div class="option"><span class="que">'+ questions[index].options[2] +'</span></div>'
    + '<div class="option"><span class="que">'+ questions[index].options[3] +'</span></div>';
